...
// new turn
        ...
        bestMove = ai.findBestMove(foundation,blocks,waste,lastMovesMap)
        assertEquals(bestMove != null, true)
        assertEquals(bestMove?.card, blocks[4].cards.first())
        assertEquals(blocks[4].hiddenCards, 4)
        game.move_(bestMove!!, foundation, blocks, waste, lastMovesMap)
        assertEquals(blocks[4].hiddenCards, 3)
        ...
        bestMove = ai.findBestMove(foundation,blocks,waste,lastMovesMap)
        assertEquals(bestMove != null, true)
        assertEquals(bestMove?.card, blocks[2].cards[0])
        assertEquals(blocks[2].hiddenCards, 2)
        game.move_(bestMove!!, foundation, blocks, waste, lastMovesMap)
        assertEquals(blocks[2].hiddenCards, 1)
        ...
        assertEquals(blocks[4].hiddenCards, 3)
        game.move_(bestMove!!, foundation, blocks, waste, lastMovesMap)
        assertEquals(blocks[4].hiddenCards, 2)
...
/*        // new turn
        ...
        assertEquals(bestMove != null, true)
        game.move_(bestMove!!, foundation, blocks, waste, lastMovesMap)
        assertEquals(blocks[0].cards.isEmpty(), true)
